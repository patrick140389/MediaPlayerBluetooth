...
public class MainActivity extends Activity {
	...
	private Button virtualizerUp;
	private Button virtualizerDown;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bassBoostUp = (Button) findViewById(R.id.bassBosstUp);
		bassBoostDown = (Button) findViewById(R.id.bassBoostDown);
		virtualizerUp = (Button) findViewById(R.id.virtualizerUp);
		virtualizerDown = (Button) findViewById(R.id.virtualizerDown);
		...
		baseMediaPlayer
				.setOnTrackPlayFinishedListener(new BaseMediaPlayerEventListener() {
		...
		virtualizerUp.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		virtualizerDown.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
	...
	private void setUptCoverFlow(final CoverFlow coverFlow) {
		...
		coverFlow.configureCoverFlow(Config.COVERFLOW_STYLEABLE.COVERFLOW
				.getCoverFlowStyleable(),
				Config.COVERFLOW_STYLEABLE.COVERFLOW_IMAGE_WIDTH
						.getCoverFlowStyleableDimensions(),
				Config.COVERFLOW_STYLEABLE.COVERFLOW_IMAGE_HEIGHT
						.getCoverFlowStyleableDimensions());

		// @formatter:on

		BaseAdapter coverImageAdapter = new CoverFlowImageAdapter(this,
				Config.DRAWABLE_RESSOURCE_CONVENTION_NAMES.toStringArray());
