package com.wessolowski.app.android.util.coverflow;
...
public class CoverFlow extends Gallery
{
	...
	private int[]			styleableCoverFlow;
	private int				styleableCoverFlowWidth;
	private int				styleableCoverFlowHeight;
	...
	private void parseAttributes(final Context context, final AttributeSet attrs)
	{
		...
		try
		{
			imageWidth = a.getDimension(styleableCoverFlowWidth, 480);
			imageHeight = a
					.getDimension(styleableCoverFlowHeight, 320);
			setSpacing(-15);
		} finally
		{
			a.recycle();
	...
	public void configureCoverFlow(int[] styleableCoverFlow, int styleableWidth, int styleableHeight)
	{
		this.styleableCoverFlow = styleableCoverFlow;
		this.styleableCoverFlowHeight = styleableHeight;
		this.styleableCoverFlowWidth = styleableWidth;
